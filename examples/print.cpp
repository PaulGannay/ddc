...
void print3d()
{
    ...
    ddc::DiscreteDomain<DDim0> const domain_x
            = ddc::init_trivial_bounded_space(ddc::DiscreteVector<DDim0>(length));
    ddc::DiscreteDomain<DDim1> const domain_y
            = ddc::init_trivial_bounded_space(ddc::DiscreteVector<DDim1>(height));
    ddc::DiscreteDomain<DDim2> const domain_z
            = ddc::init_trivial_bounded_space(ddc::DiscreteVector<DDim2>(depth));

    ddc::DiscreteDomain<DDim0, DDim1, DDim2> const domain_xyz(domain_x, domain_y, domain_z);
    ...
    ddc::parallel_for_each(
            domain_xyz,
            KOKKOS_LAMBDA(ddc::DiscreteElement<DDim0, DDim1, DDim2> const ixyz) {
...
void print2d()
{
    ...
    ddc::DiscreteDomain<DDim0, DDim1> const domain_full(domain_0, domain_1);
...
void print4d()
{
    ...
    ddc::DiscreteDomain<DDim0, DDim1, DDim2, DDim3> const
            domain_full(domain_0, domain_1, domain_2, domain_3);
